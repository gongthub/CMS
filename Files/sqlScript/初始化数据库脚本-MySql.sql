...
INSERT INTO `sys_module` VALUES ('77cdb867-c4af-4c14-999e-781c25723d34', '0', null, null, '报表管理', 'fa fa-desktop', null, 'expand', '0', '1', '0', '0', '0', '40', '0', '1', null, '2017-08-12 22:41:50', '9f2ec079-7d0f-4fe2-90ab-8b09a8302aba', '2017-08-12 22:41:50', '9f2ec079-7d0f-4fe2-90ab-8b09a8302aba', '2017-08-12 22:39:07', null);
...
CREATE TABLE `sys_requestlog` (
  ...
  `StartDateTime` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `EndDateTime` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `Description` varchar(255) DEFAULT NULL,
  `DeleteMark` tinyint(4) DEFAULT NULL,
  `EnabledMark` tinyint(4) DEFAULT NULL,
  `DeleteTime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
