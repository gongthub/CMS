...
CREATE TABLE `c_advancedcontentconfig` (
  ...
  `ColumnShowName` varchar(500) DEFAULT NULL,
...
CREATE TABLE `c_messages` (
  ...
  `UserMobile` varchar(500) DEFAULT NULL,
  `UserEmaile` varchar(500) DEFAULT NULL,
  `UserFax` varchar(500) DEFAULT NULL,
  ...
  `Description7` longtext DEFAULT NULL,
  `Description8` longtext DEFAULT NULL,
  `Description9` longtext DEFAULT NULL,
  `Description10` longtext DEFAULT NULL,
...
CREATE TABLE `sys_accesslog` (
  `Id` varchar(50) NOT NULL,
  `WebSiteId` varchar(50) DEFAULT NULL,
  `WebSiteName` varchar(500) DEFAULT NULL,
  ...
  `CountryNo` varchar(500) DEFAULT NULL,
  `BigArea` varchar(500) DEFAULT NULL,
  `Isp` varchar(500) DEFAULT NULL,
  `IsProcessIp` tinyint(4) DEFAULT NULL,
  `NetType` varchar(500) DEFAULT NULL,
  `Browser` varchar(500) DEFAULT NULL,
  `BrowserID` varchar(500) DEFAULT NULL,
  `BrowserVersion` varchar(500) DEFAULT NULL,
  `BrowserType` varchar(500) DEFAULT NULL,
  `BrowserPlatform` varchar(500) DEFAULT NULL,
  `PUrlAddress` varchar(500) DEFAULT NULL,
  `UrlAddress` varchar(500) DEFAULT NULL,
...
CREATE TABLE `sys_area` (
  ...
  `EnCode` varchar(500) DEFAULT NULL,
  `FullName` varchar(500) DEFAULT NULL,
  `SimpleSpelling` varchar(500) DEFAULT NULL,
  `SortCode` int(11) DEFAULT NULL,
  `DeleteMark` tinyint(4) DEFAULT NULL,
  `EnabledMark` tinyint(4) DEFAULT NULL,
...
CREATE TABLE `sys_dbbackup` (
  `Id` varchar(50) NOT NULL,
  `BackupType` varchar(500) DEFAULT NULL,
...
CREATE TABLE `sys_itemsdetail` (
  ...
  `ParentId` varchar(50) DEFAULT NULL,
  `ItemCode` varchar(500) DEFAULT NULL,
...
CREATE TABLE `sys_modulebutton` (
  ...
  `JsEvent` varchar(500) DEFAULT NULL,
  `UrlAddress` varchar(500) DEFAULT NULL,
...
CREATE TABLE `sys_upfiles` (
  ...
  `ModuleName` varchar(500) DEFAULT NULL,
  `FileName` varchar(500) DEFAULT NULL,
  `FileOldName` varchar(500) DEFAULT NULL,
  `ExtName` varchar(500) DEFAULT NULL,
  `FilePath` varchar(500) DEFAULT NULL,
  `FileMd5` varchar(500) DEFAULT NULL,
...
CREATE TABLE `sys_userlogon` (
  ...
  `UserSecretkey` varchar(500) DEFAULT NULL,
...
CREATE TABLE `sys_websites` (
  ...
  `SiteDesc` longtext DEFAULT NULL,
  `Description` longtext DEFAULT NULL,
  `EnabledMark` tinyint(4) DEFAULT NULL,
  `DeleteMark` tinyint(4) DEFAULT NULL,
  `MainMark` tinyint(4) DEFAULT NULL,
...
CREATE TABLE `sys_requestlog` (
  ...
  `PUrlAddress` varchar(500) DEFAULT NULL,
  `UrlAddress` varchar(500) DEFAULT NULL,
  `UrlHost` varchar(500) DEFAULT NULL,
  `UrlRaw` varchar(500) DEFAULT NULL,
  `Date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `Description` longtext DEFAULT NULL,
  `DeleteMark` tinyint(4) DEFAULT NULL,
  `EnabledMark` tinyint(4) DEFAULT NULL,
